		...
		<div class="layui-container">
			<div class="layui-row">
				...
				<div class="layui-col-md4">
					...
					<form class="layui-form" action="../LoginActionSession" method="post">
						<div class="container">

							<div class="layui-form-mid layui-word-aux">
								<img id="logoid" src="../static/images/06.png" height="35">
							</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<select name="pid">
										...
										<option value="3">校级领导</option>
										<option value="2">教育局管理员</option>
										<option value="1">教育局领导</option>
									</select>
								</div>
							</div>
							...
							<a href="" class="font-set"></a><a href="login.jsp"
								class="font-set">用户注册</a>
						</div>
